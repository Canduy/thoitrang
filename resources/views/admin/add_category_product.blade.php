                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_product_name" id="slug" onkeyup="ChangeToSlug();" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục">
                                </div>
                                 <div class="form-group">
                               ...
                               <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows= "5"   class="form-control" name="meta_keyword" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
